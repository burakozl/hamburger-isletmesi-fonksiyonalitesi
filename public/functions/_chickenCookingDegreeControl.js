...
export var chickenCookingDegreeControl = function () {
    chicken.disabled = true;
    meatball.style.display = "none";
    cookChicken.style.display = "";
    var tavuk = materials.find(function (material) { return material.name === 'tavuk'; });
    tavuk.isChecked = true;
    cookChicken.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
