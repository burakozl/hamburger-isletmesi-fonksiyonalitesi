...
export var meatballCookingDegreeControl = function () {
    meatball.disabled = true;
    chicken.style.display = "none";
    underdone.style.display = "";
    medium.style.display = "";
    overcooked.style.display = "";
    var kofte = materials.find(function (material) { return material.name === 'kofte'; });
    ...
    underdone.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    medium.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    disabledCookingTypes();
    ...
    overcooked.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    disabledCookingTypes();
