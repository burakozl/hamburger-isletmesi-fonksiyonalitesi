...
export function prepareDrink() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    patates = materials.find(function (material) { return material.name === 'patates'; });
                    icecek = materials.find(function (material) { return material.name === 'cola'; });
                    if (!(patates.isChecked && icecek.isChecked)) return [3 /*break*/, 2];
                ...
                case 1:
                    ...
                    return [3 /*break*/, 5];
                case 2:
                    if (!(!patates.isChecked && icecek.isChecked)) return [3 /*break*/, 4];
